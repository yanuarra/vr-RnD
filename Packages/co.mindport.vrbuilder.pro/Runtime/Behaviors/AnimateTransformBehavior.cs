    ...
    public class AnimateTransformBehavior : Behavior<AnimateTransformBehavior.EntityData>
    {
        ...
        public class EntityData : IBehaviorData
        {
            ...
            public string Name
            {
                get
                {
                    return $"Animate {TargetObject} to {TargetTransformProvider}";
                }
            }
        }
        ...
        private class ActivatingProcess : StageProcess<EntityData>
        {
            ...
            public override void Start()
            {
                ...
                initialPosition = Data.TargetObject.Value.GameObject.transform.localPosition;
                initialRotation = Data.TargetObject.Value.GameObject.transform.localRotation;
                initialScale = Data.TargetObject.Value.GameObject.transform.localScale;
            ...
            public override void End()
            {
                ...
                ProcessAnimation(Data.TargetObject.Value.GameObject.transform, Data.PositionCurve.Evaluate(endPositionTime), Data.RotationCurve.Evaluate(endRotationTime), Data.ScaleCurve.Evaluate(endScaleTime));
            ...
            private void ProcessAnimation(Transform movingTransform, float positionProgress, float rotationProgress, float scaleProgress)
            {
                ...
                Vector3 targetPosition = Data.TargetTransformProvider.Value.GameObject.transform.position;
                Quaternion targetRotation = Data.TargetTransformProvider.Value.GameObject.transform.rotation;
                Vector3 targetScale = Data.TargetTransformProvider.Value.GameObject.transform.localScale;
        ...
        public AnimateTransformBehavior() : this(Guid.Empty, Guid.Empty, 0f, null, null, null)
        {
            Data.Duration = 1;
        ...
        public AnimateTransformBehavior(ISceneObject target, ISceneObject transformProvider, float duration, AnimationCurve positionCurve, AnimationCurve rotationCurve, AnimationCurve scaleCurve, bool pingPong = false, int repeats = 1) : this(ProcessReferenceUtils.GetUniqueIdFrom(target), ProcessReferenceUtils.GetUniqueIdFrom(transformProvider), duration, positionCurve, rotationCurve, scaleCurve, pingPong, repeats)
        {
        }

        public AnimateTransformBehavior(Guid targetGuid, Guid transformProviderGuid, float duration, AnimationCurve positionCurve, AnimationCurve rotationCurve, AnimationCurve scaleCurve, bool pingPong = false, int repeats = 1)
        {
            Data.TargetObject = new SingleSceneObjectReference(targetGuid);
            Data.TargetTransformProvider = new SingleSceneObjectReference(transformProviderGuid);
